...
const slugCheck = async (slug: string) => {
  const res = await fetch("/api/tags/check-slug", {
    method: "POST",
...
export default function AddTagPage() {
  ...
  const [tags, setCategories] = useState<TagFormType[]>([]);
  ...
  const onSubmit = async (data: TagFormType) => {
    ...
    try {
      ...
      const res = await fetch(
        editIndex !== null ? `/api/tags/${tags[editIndex]._id}` : "/api/tags",
        {
      ...
      toast.success(editIndex !== null ? "Tag updated!" : "Tag created!", {
        id: toastId,
      });
      if (editIndex !== null) {
        const updated = [...tags];
  ...
  const filteredCategories = tags.filter((cat) =>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-md shadow-lg overflow-hidden">
              <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6">
                <h2 className="text-xl font-bold text-white">
                  {editIndex !== null ? "Edit Tag" : "Create New Tag"}
                </h2>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 "
            ...
            <div className="bg-white dark:bg-gray-800 rounded-md shadow-lg overflow-hidden">
              <div className="bg-gradient-to-r from-indigo-600 to-purple-700 p-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div>
                    <h2 className="text-xl font-bold text-white">Tag List</h2>
                    <p className="text-indigo-100 mt-1">Manage existing tags</p>
                  </div>
                                ...
                                <div className="flex justify-end space-x-2">
                                  <button
                                    onClick={() => {
                                      ...
                                      setEditIndex(
                                        tags.findIndex((c) => c._id === cat._id)
                                      );
                                    }}
